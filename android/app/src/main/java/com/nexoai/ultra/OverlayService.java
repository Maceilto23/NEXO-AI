...
public class OverlayService extends Service {
    ...
    private void show(){
        wm=(WindowManager)getSystemService(WINDOW_SERVICE); ImageView v=new ImageView(this); v.setImageResource(R.drawable.nexo_ai_avatar); v.setPadding(Ui.dp(this,6),Ui.dp(this,6),Ui.dp(this,6),Ui.dp(this,6)); bubble=v;
