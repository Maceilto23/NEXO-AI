...
public class AssistantActivity extends Activity {
    ...
    private void render(){
        ...
        LinearLayout head=new LinearLayout(this); head.setGravity(Gravity.CENTER_VERTICAL); ImageView icon=new ImageView(this); icon.setImageResource(R.drawable.ic_robot); head.addView(icon,new LinearLayout.LayoutParams(Ui.dp(this,46),Ui.dp(this,46))); TextView tt=Ui.title(this,"Nexo AI",24); tt.setPadding(Ui.dp(this,10),0,0,0); head.addView(tt); root.addView(head);
