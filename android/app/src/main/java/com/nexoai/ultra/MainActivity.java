...
public class MainActivity extends Activity {
    ...
    private void render(){
        ...
        ImageView icon=new ImageView(this); icon.setImageResource(R.drawable.ic_robot); hero.addView(icon,new LinearLayout.LayoutParams(Ui.dp(this,58),Ui.dp(this,58)));
        ...
        Button overlay=Ui.button(this,"Ativar robô flutuante"); overlay.setOnClickListener(v->toggleOverlay()); root.addView(overlay,buttonParams());
    ...
    private void toggleOverlay(){
        ...
        Intent i=new Intent(this,OverlayService.class); if(Build.VERSION.SDK_INT>=26)startForegroundService(i); else startService(i); Toast.makeText(this,"Robô Nexo AI ativado",Toast.LENGTH_SHORT).show();
    }
